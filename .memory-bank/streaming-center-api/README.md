...
Streaming.Center API поддерживает управление сеткой вещания через **Scheduler API**:

- ✅ **Планирование плейлистов** — запуск плейлистов в определенное время
- ✅ **Запуск треков по расписанию** — запуск конкретных треков в нужное время
- ✅ **Ежедневное/еженедельное расписание** — повторяющиеся события
- ✅ **Управление джинглами и рекламой** — планирование с временными интервалами

Подробнее см. [Scheduler API](./07-scheduler-api.md).
